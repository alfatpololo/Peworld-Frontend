    ...
    const onSubmit =  (e) => {
        ...
        if(form.name == "" || form.phone == "" || form.password == ""){
            ...
            if (form.password !== form.password2) {
              ...
              router.push("/Auth/Registerworkers")
            } else {
            const body = {
                name: form.name,
            ...
            <form onSubmit={(e) => onSubmit(e)}>
              ...
              <div className="flex flex-wrap pt-10">
                <label for="name" class=" text-sm font-normal text-softGrey pb-4">Name</label>
                    <input type="text" id="name" onChange={(e) => setForm({...form, name: e.target.value})} placeholder="Masukan nama panjang" class="w-full bg-white ring-lightGrey ring-2 text-dark p-4 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary" />
              </div>
              <div className="flex flex-wrap pt-10">
