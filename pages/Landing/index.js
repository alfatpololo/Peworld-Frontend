          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              <div className="flex flex-wrap pt-5">
                <img src="/tick 1.png" className="pt-6" alt="" />
            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              <div className="flex flex-wrap">
                <div className="w-1/2 px-4 lg:w-1/2">
                  <div className="flex flex-wrap pt-5">
                    <img src="/tick 13.png" className="pt-6" alt="" />
                    <p className="px-3 pt-6">Java</p>
                  </div>
                  <div className="flex flex-wrap">
                    <img src="/tick 13.png" className="pt-6" alt="" />
                    <p className="px-3 pt-6">Kotlin</p>
                  </div>
                  <div className="flex flex-wrap">
                    <img src="/tick 13.png" className="pt-6" alt="" />
                    <p className="px-3 pt-6">PHP</p>
                  </div>
                  <div className="flex flex-wrap">
                    <img src="/tick 13.png" className="pt-6" alt="" />
                    <p className="px-3 pt-6">Javascript</p>
                  </div>
                </div>
                <div className="w-1/2 px-4 lg:w-1/2">
                  <div className="flex flex-wrap pt-5">
                    <img src="/tick 13.png" className="pt-6" alt="" />
                    <p className="px-3 pt-6">Golang</p>
                  </div>
                  <div className="flex flex-wrap">
                    <img src="/tick 13.png" className="pt-6" alt="" />
                    <p className="px-3 pt-6">C++</p>
                  </div>
                  <div className="flex flex-wrap">
                    <img src="/tick 13.png" className="pt-6" alt="" />
                    <p className="px-3 pt-6">Ruby</p>
                  </div>
                  <div className="flex flex-wrap">
                    <img src="/tick 13.png" className="pt-6" alt="" />
                    <p className="px-3 pt-6">10+</p>
                  </div>
                </div>
              </div>
            </div>
