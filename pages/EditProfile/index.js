...
const handlePost = (e) => {
  ...
  console.log(form)
  axios
      .put(`http://localhost:3001/user/update/${id}`, form)
      .then((res) => {
          console.log(res);
      ...
      <div className="container">
          ...
          {dataUser.map((item, index) => (
            <>
              ...
              <div className="w-full pt-5">
                  <h1 className="text-center text-sm font-normal text-dark">{item.job_desk}</h1>
              </div>
              <div className="w-full pt-5">
                  <h1 className="text-center text-sm font-normal text-softGrey">{item.title}</h1>
              </div>
              <div className="w-full pt-5">
