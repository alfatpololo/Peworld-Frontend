    ...
    <>
      ...
      <section className="pt-40 z-1 relative">
        <div className="container">
          ...
          <div className="w-full pt-5">
              <h1 className="text-center text-sm font-normal text-dark">{dataUser.job_desk} </h1>
          </div>
          <div className="w-full pt-5">
              <h1 className="text-center text-sm font-normal text-softGrey">{dataUser.city}</h1>
          </div>
          <div className="w-full pt-5">
              <h1 className="text-center text-sm font-normal text-softGrey">{dataUser.tempat_kerja}</h1>
          </div>
          <div className="w-full pt-5">
